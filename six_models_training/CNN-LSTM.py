...
def main():
    ...
    train_losses, val_losses, best_model_path = train_model(model, train_ds, val_ds, device, num_epochs=100, batch_size=8)

    model.load_state_dict(torch.load('best_CNNLSTM_model_2010_2023.pth'))
