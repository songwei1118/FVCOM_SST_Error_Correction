...
# ==================== 4. Spatial Position Encoding and Multi-Scale Feature Extraction ====================
...
# ==================== 7. Model Training and Optimization Strategy ====================
class Trainer:
    ...
    def train(self, train_loader, val_loader, num_epochs=50,
              save_path='MSCT-PE-FVCOM-2010-2023-best_model.pth'):
...
def main():
    ...
    print("=" * 60)
    print("MSCT-PE-FVCOM: FVCOM SST Bias Correction Model")
    print("=" * 60)
    ...
    history = trainer.train(
        ...
        num_epochs=100,
        save_path='MSCT-PE-FVCOM-2010-2023-best-model.pth'
    )
