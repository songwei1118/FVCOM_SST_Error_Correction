...
def plot_scatter_prediction_vs_observation(
        ...
        device,
        last_n_samples=None,
        save_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Summer-有气压_scatter_pred_vs_obs_testset.png'):
    model.eval()
    ...
    plt.title(
        f'Predicted vs Observed SST (Summer test set)\n'
...
def main():
    ...
    history = trainer.train(
        ...
        num_epochs=100,
        save_path='MSCT-PE-FVCOM Summer_best_model.pth'
    )

    best_model_path = 'MSCT-PE-FVCOM Summer_best_model.pth'
