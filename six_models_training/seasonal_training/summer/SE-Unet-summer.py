...
def train_model(model, train_dataset, val_dataset, device, num_epochs=100, batch_size=32, lr=5e-4,
    ...
    best_model_path = os.path.join(save_dir, "best_resunet_model_seunet_夏季.pth")
    epochs_no_improve = 0
