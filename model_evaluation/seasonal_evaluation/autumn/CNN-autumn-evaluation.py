...
def plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model='Autumn CNN-FVCOM-RMSE_model_crop.png',
                   final_path_fvcom='Autumn CNN-FVCOM-RMSE_fvcom_crop.png'):
    ...
    draw_and_crop(rmse_fvcom, 'Autumn FVCOM RMSE ', final_path_fvcom)
    draw_and_crop(rmse_model, 'Autumn CNN-FVCOM RMSE ', final_path_model)
...
def plot_mean_temperature_map_comparison(
        ...
        mean_Y, std_Y,
        device,
        save_path_sat='Autumn CNN-FVCOM-SST_satellite_mean.png',
        save_path_fvcom='Autumn CNN-FVCOM-SST_fvcom_mean.png',
        save_path_model='Autumn CNN-FVCOM-SST_model_mean.png'):
    ...
    draw_single(sst_mean, 'Autumn Satellite SST', save_path_sat)
    draw_single(fvcom_mean, 'Autumn FVCOM SST', save_path_fvcom)
    draw_single(pred_mean, 'Autumn CNN-FVCOM SST', save_path_model)


def main():
    output_dir = r'./秋季-CNN-FVCOM-results_2010_2023'
    ...
    best_model_path = r'D:\CNN\cnn模型\best_cnn_resnet_se_model_2010_2023_秋季.pth'
    ...
    csv_path = 'evaluation_metrics_CNN_2010_2023_秋季.csv'
    ...
    plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model=os.path.join(output_dir, 'Autumn-CNN-FVCOM-model_rmse_final.png'),
                   final_path_fvcom=os.path.join(output_dir, 'Autumn-CNN-FVCOM-fvcom_rmse_final.png'))
    ...
    plot_mean_temperature_map_comparison(
        ...
        save_path_sat=os.path.join(output_dir, 'Autumn-CNN-FVCOM-SST_satellite_mean.png'),
        save_path_fvcom=os.path.join(output_dir, 'Autumn-CNN-FVCOM-SST_fvcom_mean.png'),
        save_path_model=os.path.join(output_dir, 'Autumn-CNN-FVCOM-SST_model_mean.png')
    )
