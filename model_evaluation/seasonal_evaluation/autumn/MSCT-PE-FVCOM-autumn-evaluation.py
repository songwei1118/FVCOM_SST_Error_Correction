...
class Trainer:
    ...
    def train(self, train_loader, val_loader, num_epochs=50,
              save_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Autumn-有气压_best_model.pth'):
...
def plot_temperature_comparison(model, test_dataset, means_X, stds_X, mean_Y, std_Y, device,
                                num_samples=60, output_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Autumn-有气压_temperature_comparison.png'):
    model.eval()
    ...
    plt.title(f'Last {len(time_steps)} test samples temperature comparison (2010-2023 Autumn)', fontsize=18, fontweight='bold')
...
def plot_mean_temperature_map_comparison(
        ...
        mean_Y, std_Y,
        device,
        output_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Autumn-有气压_mean_temperature_map_comparison.png'):
    ...
    plt.suptitle(
        '2010-2023 Autumn test-set mean SST spatial comparison',
        fontsize=16, fontweight='bold'
    )
...
def main():
    ...
    best_model_path = 'CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Autumn-有气压_best_model.pth'
    ...
    save_path = "秋季-多尺度CNN-Transformer-evaluation_metrics_2010_2023.csv"
    ...
    plot_temperature_comparison(
        ...
        device=device,
        num_samples=60,
        output_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Autumn-有气压_temperature_comparison.png'
    )
    ...
    }, 'CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Autumn-有气压_final_model.pth')

    print("✅ Model and results saved!")

    print("\n" + "=" * 60)
    print("📊 Memory usage report (2010-2023 Autumn)")
    print("=" * 60)
    ...
    print(f"\n📅 Data time range: 2010-2023 Autumn")
