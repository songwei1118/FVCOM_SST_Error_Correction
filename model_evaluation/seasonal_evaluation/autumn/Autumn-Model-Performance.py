...
csv_files = [
    r"D:\CNN\cnn模型\evaluation_metrics_CNN_2010_2023_秋季.csv",
    r"D:\CNN\convLSTM模型\CNNLSTM_秋季_test_metrics_2010_2023.csv",
    r"D:\CNN\convtransformer模型\秋季-多尺度CNN-Transformer-evaluation_metrics_2010_2023.csv",
    r"D:\CNN\SA_Unet模型\results_UNet_SA_year_2010_2023_autumn\evaluation_results_saunet_year_2010_2023_autumn.csv",
    r"D:\CNN\SE_Unet模型\results_UNet_SE_autumn_2010_2023\evaluation_results_seunet_year_2010_2023_autumn.csv",
    r"D:\CNN\CBAM_Unet模型\results_UNet_CBAM_year_2010_2023_秋季\evaluation_results_CBAMunet_year_2010_2023_autumn.csv"
]
...
ax1.set_title("Autumn", fontsize=28, fontweight='bold')
...
plt.savefig("Autumn_RMSE_MAE_Comparison.png", dpi=300, bbox_inches='tight')


plt.savefig("Autumn_RMSE_MAE_Comparison.pdf", dpi=300, bbox_inches='tight')
