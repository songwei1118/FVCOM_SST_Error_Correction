...
csv_files = [
    r"D:\CNN\cnn模型\evaluation_metrics_CNN_2010_2023_冬季.csv",
    r"D:\CNN\convLSTM模型\CNNLSTM_冬季_test_metrics_2010_2023.csv",
    r"D:\CNN\convtransformer模型\冬季-多尺度CNN-Transformer-evaluation_metrics_2010_2023.csv",
    r"D:\CNN\SA_Unet模型\results_UNet_SA_year_2010_2023_winter\evaluation_results_saunet_year_2010_2023_winter.csv",
    r"D:\CNN\SE_Unet模型\results_UNet_SE_winter_2010_2023\evaluation_results_seunet_year_2010_2023_winter.csv",
    r"D:\CNN\CBAM_Unet模型\results_UNet_CBAM_year_2010_2023_冬季\evaluation_results_CBAMunet_year_2010_2023_winter.csv"
]
...
ax1.set_xticks(x)
ax1.set_xticklabels(labels, fontsize=24)     # 调整 X 轴字体
ax1.set_title("Winter", fontsize=28, fontweight='bold')       # 调整 标题 字体
...
plt.savefig("Winter_RMSE_MAE_Comparison.png", dpi=300, bbox_inches='tight')


plt.savefig("Winter_RMSE_MAE_Comparison.pdf", dpi=300, bbox_inches='tight')
