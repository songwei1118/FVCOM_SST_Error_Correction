...
def main():
    ...
    save_path = "冬季-多尺度CNN-Transformer-evaluation_metrics_2010_2023.csv"
    ...
    plot_temperature_comparison(
        ...
        device=device,
        num_samples=60,
        output_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Winter-有气压_temperature_comparison.png'
    )
    ...
    }, 'CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Winter-有气压_final_model.pth')

    print("✅ Model and results saved!")

    print("\n" + "=" * 60)
    print("📊 Memory usage report (2010-2023 Winter)")
    print("=" * 60)
    ...
    print(f"\n📅 Data time range: 2010-2023 Winter")
