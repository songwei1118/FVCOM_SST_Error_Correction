...
def plot_temperature_comparison(model, test_dataset, means_X, stds_X, mean_Y, std_Y, device,
                                num_samples=60, output_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Spring-有气压_temperature_comparison.png'):
    model.eval()
    ...
    plt.title(f'Last {len(time_steps)} test samples temperature comparison (2010-2023 Spring)', fontsize=18, fontweight='bold')
...
def plot_mean_temperature_map_comparison(
        ...
        mean_Y, std_Y,
        device,
        output_path='CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Spring-有气压_mean_temperature_map_comparison.png'):
    ...
    plt.suptitle(
        '2010-2023 Spring test-set mean SST spatial comparison',
        fontsize=16, fontweight='bold'
    )
...
def main():
    ...
    output_dir = r'./春季-MSCT-PE-results_2010_2023'
    ...
    best_model_path = 'CNN-Transformer-多尺度35绝对位置编码-动态学习率2010-2023 Spring-有气压_best_model.pth'
    ...
    save_path = os.path.join(output_dir, "春季-MSCT-PE-evaluation_metrics.csv")
    ...
    plot_temperature_comparison(
        ...
        device=device,
        num_samples=60,
        output_path=os.path.join(output_dir, '春季-MSCT-PE-temperature_comparison.png')
    )
    ...
    plot_mean_temperature_map_comparison(
        ...
        std_Y=data['std_Y'],
        device=device,
        output_path=os.path.join(output_dir, '春季-MSCT-PE-mean_temperature_map.png')
    )
    ...
    print("\n" + "=" * 60)
    print("📊 Memory usage report (2010-2023 Spring)")
    print("=" * 60)
    ...
    print(f"\n📅 Data time range: 2010-2023 Spring")
