...
csv_files = [
    r"D:\CNN\cnn模型\evaluation_metrics_CNN_2010_2023_春季.csv",
    r"D:\CNN\convLSTM模型\CNNLSTM_春季_test_metrics_2010_2023.csv",
    r"D:\CNN\convtransformer模型\春季-evaluation_metrics_2010_2023.csv",
    r"D:\CNN\SA_Unet模型\results_UNet_SA_year_2010_2023_spring\evaluation_results_saunet_year_2010_2023_spring.csv",
    r"D:\CNN\SE_Unet模型\results_UNet_SE_spring_2010_2023\evaluation_results_seunet_year_2010_2023_spring.csv",
    r"D:\CNN\CBAM_Unet模型\results_UNet_CBAM_year_2010_2023_春季\evaluation_results_CBAMunet_year_2010_2023_spring.csv"
]
...
ax1.set_title("Spring", fontsize=28, fontweight='bold')
...
plt.savefig("Spring_RMSE_MAE_Comparison.png", dpi=300, bbox_inches='tight')


plt.savefig("Spring_RMSE_MAE_Comparison.pdf", dpi=300, bbox_inches='tight')
