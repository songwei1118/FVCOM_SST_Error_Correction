...
def plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model='SA-Unet-FVCOM-RMSE_model_crop.png',
                   final_path_fvcom='SA-Unet-FVCOM-RMSE_fvcom_crop.png'):
    ...
    draw_and_crop(rmse_model, 'SA-Unet-FVCOM RMSE ', final_path_model)
...
def plot_mean_temperature_map_comparison(
        ...
        mean_Y, std_Y,
        device,
        save_path_sat='SA-Unet-FVCOM-SST_satellite_mean.png',
        save_path_fvcom='SA-Unet-FVCOM-SST_fvcom_mean.png',
        save_path_model='SA-Unet-FVCOM-SST_model_mean.png'):
    ...
    draw_single(pred_mean, 'SA-Unet-FVCOM SST', save_path_model)
...
def plot_bias_maps(bias_model, bias_fvcom,
    ...
    draw(bias_model, "SA-Unet-FVCOM Bias", save_path_model)
...
def main():
    ...
    save_path = os.path.join(output_dir, "SA-Unet-evaluation_metrics.csv")
    ...
    np.save(os.path.join(output_dir, "SA-Unet-FVCOM_bias_model.npy"), bias_model)
    np.save(os.path.join(output_dir, "SA-Unet-FVCOM_bias_fvcom.npy"), bias_fvcom)

    np.save(os.path.join(output_dir, "SA-Unet-FVCOM_rmse_model.npy"), rmse_model)
    np.save(os.path.join(output_dir, "SA-Unet-FVCOM_rmse_fvcom.npy"), rmse_fvcom)

    np.save(os.path.join(output_dir, "SA-Unet-FVCOM_improvement.npy"), improvement)

    print("Spatial statistics saved (for post-processing plots)")

    plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model=os.path.join(output_dir, 'SA-Unet-FVCOM-model_rmse_final.png'),
                   final_path_fvcom=os.path.join(output_dir, 'SA-Unet-FVCOM-fvcom_rmse_final.png'))
    ...
    plot_bias_maps(
        bias_model,
        bias_fvcom,
        save_path_model=os.path.join(output_dir, 'SA-Unet-FVCOM-bias_model.png'),
        save_path_fvcom=os.path.join(output_dir, 'SA-Unet-FVCOM-bias_fvcom.png')
    )

    print("\nStep 8: Plotting spatial mean SST comparison")
    plot_mean_temperature_map_comparison(
        ...
        save_path_sat=os.path.join(output_dir, 'SA-Unet-FVCOM-SST_satellite_mean.png'),
        save_path_fvcom=os.path.join(output_dir, 'SA-Unet-FVCOM-SST_fvcom_mean.png'),
        save_path_model=os.path.join(output_dir, 'SA-Unet-FVCOM-SST_model_mean.png')
    )
