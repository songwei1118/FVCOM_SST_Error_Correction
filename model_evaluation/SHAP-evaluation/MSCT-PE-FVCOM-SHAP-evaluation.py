...
def main():
    ...
    colors_dict = {
        "KM": "#d73027", "short_wave": "#fc8d59", "air_temp": "#fee08b",
        "long_wave": "#d9ef8b", "V": "#91bfdb", "U10": "#4575b4",
        "V10": "#4575b4", "u": "#4575b4", "air_pressure": "#4575b4"
    }
    ...
    plot_feature_importance(
        df,
        save_path=os.path.join(save_dir, "shap_importance_bar_全年.png")
    )
