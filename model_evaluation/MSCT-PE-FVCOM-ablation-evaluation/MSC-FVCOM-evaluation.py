...
class Trainer:
    ...
    def train(self, train_loader, val_loader, num_epochs=100,
              save_path='cnn-多尺度-消融实验-动态学习率2010-2023-有气压_best_model.pth'):
...
def plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model='消融实验-MSC-FVCOM-RMSE_model_crop.png',
                   final_path_fvcom='消融实验-MSC-FVCOM-RMSE_fvcom_crop.png'):
    ...
    draw_and_crop(rmse_model, 'MSC-FVCOM RMSE ', final_path_model)
...
def plot_mean_temperature_map_comparison(
        ...
        mean_Y, std_Y,
        device,
        save_path_sat='消融实验-MSC-FVCOM-SST_satellite_mean.png',
        save_path_fvcom='消融实验-MSC-FVCOM-SST_fvcom_mean.png',
        save_path_model='消融实验-MSC-FVCOM-SST_model_mean.png'):
    ...
    draw_single(pred_mean, 'MSC-FVCOM SST', save_path_model)
...
def plot_bias_maps(bias_model, bias_fvcom,
    ...
    draw(bias_model, "MSC-FVCOM Bias", save_path_model)


def main():

    output_dir = r'./消融实验-MSC-results_2010_2023'
    ...
    print("\nStep 4: Creating ablation model (CNN only)")
    ...
    best_model_path = 'cnn-多尺度-消融实验-动态学习率2010-2023-有气压_best_model.pth'
    ...
    save_path = os.path.join(output_dir, "消融实验-MSC-FVCOM-evaluation_metrics.csv")
    ...
    np.save(os.path.join(output_dir, "消融实验-MSC-FVCOM_bias_model.npy"), bias_model)
    np.save(os.path.join(output_dir, "消融实验-MSC-FVCOM_bias_fvcom.npy"), bias_fvcom)

    np.save(os.path.join(output_dir, "消融实验-MSC-FVCOM_rmse_model.npy"), rmse_model)
    np.save(os.path.join(output_dir, "消融实验-MSC-FVCOM_rmse_fvcom.npy"), rmse_fvcom)

    np.save(os.path.join(output_dir, "消融实验-MSC-FVCOM_improvement.npy"), improvement)

    print("Spatial statistics saved (for post-processing plots)")

    plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model=os.path.join(output_dir, '消融实验-MSC-FVCOM-model_rmse_final.png'),
                   final_path_fvcom=os.path.join(output_dir, '消融实验-MSC-FVCOM-fvcom_rmse_final.png'))
    ...
    plot_bias_maps(
        bias_model,
        bias_fvcom,
        save_path_model=os.path.join(output_dir, '消融实验-MSC-FVCOM-bias_model.png'),
        save_path_fvcom=os.path.join(output_dir, '消融实验-MSC-FVCOM-bias_fvcom.png')
    )
    ...
    plot_mean_temperature_map_comparison(
        ...
        save_path_sat=os.path.join(output_dir, '消融实验-MSC-FVCOM-SST_satellite_mean.png'),
        save_path_fvcom=os.path.join(output_dir, '消融实验-MSC-FVCOM-SST_fvcom_mean.png'),
        save_path_model=os.path.join(output_dir, '消融实验-MSC-FVCOM-SST_model_mean.png')
    )
