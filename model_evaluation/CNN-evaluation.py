...
def plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model='CNN-FVCOM-RMSE_model_crop.png',
                   final_path_fvcom='CNN-FVCOM-RMSE_fvcom_crop.png'):
...
def plot_mean_temperature_map_comparison(
        ...
        mean_Y, std_Y,
        device,
        save_path_sat='CNN-FVCOM-SST_satellite_mean.png',
        save_path_fvcom='CNN-FVCOM-SST_fvcom_mean.png',
        save_path_model='CNN-FVCOM-SST_model_mean.png'):
...
def main():
    ...
    best_model_path = r'D:\CNN\cnn模型\best_cnn_resnet_se_model_2010_2023.pth'
    ...
    save_path = os.path.join(output_dir, "CNN-evaluation_metrics.csv")
    ...
    np.save(os.path.join(output_dir, "CNN-FVCOM_bias_model.npy"), bias_model)
    np.save(os.path.join(output_dir, "CNN-FVCOM_bias_fvcom.npy"), bias_fvcom)

    np.save(os.path.join(output_dir, "CNN-FVCOM_rmse_model.npy"), rmse_model)
    np.save(os.path.join(output_dir, "CNN-FVCOM_rmse_fvcom.npy"), rmse_fvcom)

    np.save(os.path.join(output_dir, "CNN-FVCOM_improvement.npy"), improvement)

    print("✅ Spatial statistics saved (for post-processing plots)")

    plot_rmse_maps(rmse_model, rmse_fvcom,
                   final_path_model=os.path.join(output_dir, 'CNN-FVCOM-model_rmse_final.png'),
                   final_path_fvcom=os.path.join(output_dir, 'CNN-FVCOM-fvcom_rmse_final.png'))

    print("\n🌡️ Step 7: Plotting bias maps")

    plot_bias_maps(
        bias_model,
        bias_fvcom,
        save_path_model=os.path.join(output_dir, 'CNN-FVCOM-bias_model.png'),
        save_path_fvcom=os.path.join(output_dir, 'CNN-FVCOM-bias_fvcom.png')
    )


    print("\n🗺️ Step 8: Plotting spatial mean temperature comparison")
    plot_mean_temperature_map_comparison(
        ...
        save_path_sat=os.path.join(output_dir, 'CNN-FVCOM-SST_satellite_mean.png'),
        save_path_fvcom=os.path.join(output_dir, 'CNN-FVCOM-SST_fvcom_mean.png'),
        save_path_model=os.path.join(output_dir, 'CNN-FVCOM-SST_model_mean.png')
    )
