...
def load_data(
        file_path=r'D:\CNN\春季数据处理\output_2010_2023_full_year_strict\data_with_mask_2010_2023_full_year.mat'):
...
def plot_bias_maps(
    ...
    model_path = os.path.join(
        save_dir,
        'longest_MHW_20230511_20230827_CNN-LSTM-FVCOM_Bias.png'
    )

    plot_single_bias_map(
        bias=bias_model,
        title='CNN-LSTM-FVCOM Bias',
    ...
    print(f"CNN-LSTM-FVCOM: {model_path}")
...
def main():
    output_dir =  r'./CNN-LSTM-longest-MHW-2023'
    ...
    best_model_path = (
        r"D:\CNN\convLSTM模型\best_CNNLSTM_model_2010_2023.pth"
    )
    ...
    results_path = os.path.join(
        output_dir,
        'CNN_LSTM_full_test_set_evaluation_metrics.csv'
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CNN-LSTM-longest_MHW_20230511_20230827_bias_model.npy'
        ),
        bias_model
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CNN-LSTM-longest_MHW_20230511_20230827_bias_fvcom.npy'
        ),
        bias_fvcom
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CNN-LSTM-longest_MHW_20230511_20230827_rmse_model.npy'
        ),
        rmse_model
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CNN-LSTM-longest_MHW_20230511_20230827_rmse_fvcom.npy'
        ),
        rmse_fvcom
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CNN-LSTM-longest_MHW_20230511_20230827_improvement.npy'
        ),
        improvement
    )
    ...
    plot_rmse_maps(
        ...
        final_path_model=os.path.join(
            output_dir,
            'longest_MHW_20230511_20230827_CNN-LSTM-FVCOM_RMSE.png'
        ),
    ...
    print(
        "CNN-LSTM-FVCOM Bias = "
        "CNN-LSTM-FVCOM SST - Satellite SST"
    )
