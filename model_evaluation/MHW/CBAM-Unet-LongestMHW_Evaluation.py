...
def plot_bias_maps(
    ...
    model_path = os.path.join(
        save_dir,
        'longest_MHW_20230511_20230827_CBAM-Unet-FVCOM_Bias.png'
    )

    plot_single_bias_map(
        bias=bias_model,
        title='CBAM-Unet-FVCOM Bias',
    ...
    print(f"CBAM-Unet-FVCOM: {model_path}")
...
def main():
    ...
    output_dir = r'./CBAM-Unet-longest-MHW-2023'
    ...
    results_path = os.path.join(
        output_dir,
        'CBAM-Unet_full_test_set_evaluation_metrics.csv'
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CBAM-Unet-longest_MHW_20230511_20230827_bias_model.npy'
        ),
        bias_model
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CBAM-Unet-longest_MHW_20230511_20230827_bias_fvcom.npy'
        ),
        bias_fvcom
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CBAM-Unet-longest_MHW_20230511_20230827_rmse_model.npy'
        ),
        rmse_model
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CBAM-Unet-longest_MHW_20230511_20230827_rmse_fvcom.npy'
        ),
        rmse_fvcom
    )
    ...
    np.save(
        os.path.join(
            output_dir,
            'CBAM-Unet-longest_MHW_20230511_20230827_improvement.npy'
        ),
        improvement
    )
    ...
    plot_rmse_maps(
        ...
        final_path_model=os.path.join(
            output_dir,
            'longest_MHW_20230511_20230827_CBAM-Unet-FVCOM_RMSE.png'
        ),
    ...
    print(
        "CBAM-Unet-FVCOM Bias = "
        "CBAM-Unet-FVCOM SST - Satellite SST"
    )
